        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            <div class="container">
                ...
                <ul class="navbar-nav m-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="product.html">Serviços</a>
                    </li>
                    <li class="nav-item">
        ...
        <main>
            ...
            <div class="container bootstrap snippet">
                <div class="row">
                    ...
                    <div class="col-sm-2"><a href="/users" class="pull-right"><img title="profile image" class="img-circle img-responsive" src="Imagens/Logo.png"></a></div>
                </div>
                <div class="row">
