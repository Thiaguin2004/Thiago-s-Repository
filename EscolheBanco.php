...
<body>
    ...
    <main>
        <!-- Card -->
        <h3 style="font-family:'Times New Roman', Times, serif;" class="display-4 text-center">Escolha o banco para solicitar o serviço</h3>
        <hr class="bg-dark mb-4 w-25">
        <h4 style="font-family:'Times New Roman', Times, serif;" class="text-center">Serviço solicitado: <?php echo $servico;?></h4>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                    <div class="card">
                        ...
                        <div class="card-block p-3">
                            ...
                            <p class="card-text">A caixa Econômica Federal é uma instituição financeira brasileira,
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                    <div class="card">
                        ...
                        <div class="card-block p-3">
                            ...
                            <p class="card-text">Banco do Brasil é um banco brasileiro, constituído na forma de
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                    <div class="card">
                        ...
                        <div class="card-block p-3">
                            ...
                            <p class="card-text">Com um modelo de atuação eficiente, focado em atividades
                                prioritárias,
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
                    <div class="card">
                        ...
                        <div class="card-block p-3">
                            ...
                            <p class="card-text">Banco Inter é um banco brasileiro, constituído na forma de
                                sociedade
