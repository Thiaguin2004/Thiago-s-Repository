...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="container">
        ...
        <ul class="navbar-nav m-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href=<?php if($_GET['token']=="logado"){echo"/sistemakiwi/product.php?token=logado";}
                             else if($_GET['token']!="logado"){echo"/sistemakiwi/product.php";} ?>>Serviços</a>
                    </li>
                    <li class="nav-item">
...
<input type="text" name="token" class="form-control" hidden value="<?php $_GET['token'];?>" />
    <main>
        <section class="text-center">
            <div class="container">
                <p></p>
                <h1 class="jumbotron-heading ">Contato Comercial</h1>
        ...
        <section>
                ...
                <div class="row">
                    <div class="col">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="Central.html">Página Central</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <div class="card-header bg-primary text-white"><i class="fa fa-envelope"></i> Solicitação de contato.
                            </div>
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="email" aria-describedby="emailHelp" placeholder="Informe seu e-mail" required>
